...
unsigned char USI_TWI_START_Read_Data(unsigned char *, unsigned char);


unsigned char USI_TWI_Get_State_Info(void);
void USI_TWI_Prepare_Buffer(unsigned char dev_addr, uint8_t read_bit,unsigned char int_addr,unsigned char msg, unsigned char * buffer);